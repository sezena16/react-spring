...
var Point = _interopDefault(require('@mapbox/point-geometry'));
...
var GoogleMapMarkers = /*#__PURE__*/function (_Component) {
  ...
  function GoogleMapMarkers(props) {
    ...
    _this._onMouseChangeHandlerRaf = function () {
      ...
      if (mp) {
        ...
        React__default.Children.forEach(_this.state.children, function (child, childIndex) {
          if (!child) return;
  ...
  _proto.render = function render() {
    ...
    var markers = React__default.Children.map(this.state.children, function (child, childIndex) {
...
function GoogleMapMarkersPrerender (props) {
  return /*#__PURE__*/React__default.createElement("div", {
    style: style$2
  }, /*#__PURE__*/React__default.createElement(GoogleMapMarkers, _extends({}, props, {
    prerender: true
  })));
}
...
var GoogleMap = /*#__PURE__*/function (_Component) {
  ...
  function GoogleMap(props) {
    ...
    _this._renderPortal = function () {
      return /*#__PURE__*/React__default.createElement(GoogleMapMarkers, {
  ...
  _proto.render = function render() {
    ...
    var mapMarkerPrerender = !overlay ? /*#__PURE__*/React__default.createElement(GoogleMapMarkersPrerender, {
    ...
    }, /*#__PURE__*/React__default.createElement(GoogleMapMap, {
...
function fitNwSe(nw, se, width, height) {
  ...
  var zoomX = log2(width / GOOGLE_TILE_SIZE / Math.abs(dx));
  var zoomY = log2(height / GOOGLE_TILE_SIZE / Math.abs(dy));
  var zoom = Math.floor(EPS + Math.min(zoomX, zoomY));
  var middle = {
    x: nwWorld.x < seWorld.x ? 0.5 * (nwWorld.x + seWorld.x) : nwWorld.x + seWorld.x - 1 > 0 ? 0.5 * (nwWorld.x + seWorld.x - 1) : 0.5 * (1 + nwWorld.x + seWorld.x),
